...
def get_root_logger():
    ...
    raise RuntimeError("No compatible logger backend found for TinyViM.")
...
def load_checkpoint_compat(path, logger):
    ...
    raise RuntimeError("No compatible checkpoint loader found for TinyViM.")
...
class TinyViM(nn.Module):
    ...
    def init_weights(self, pretrained=None):
        ...
        if self.init_cfg is None and pretrained is None:
            ...
            ckpt = load_checkpoint_compat(
                ckpt_path, logger=logger)
