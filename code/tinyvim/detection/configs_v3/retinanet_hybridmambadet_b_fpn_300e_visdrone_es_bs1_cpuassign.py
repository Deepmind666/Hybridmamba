# HybridMambaDet-B + RetinaNet + FPN on VisDrone V2, aligned with
# `retinanet_tinyvim_b_fpn_300e_visdrone_es_bs1_cpuassign.py` for BMVC mainline comparison.
_base_ = [
...
work_dir = './work_dirs_v3/retinanet_hybridmambadet_b_fpn_300e_visdrone_es_bs1_cpuassign'
