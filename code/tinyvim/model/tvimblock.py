...
try:
    ...
    _SELECTIVE_SCAN_BACKEND = "mamba"
except ImportError:
    import selective_scan_cuda_oflex as selective_scan_cuda
    _SELECTIVE_SCAN_BACKEND = "oflex"
...
class SelectiveScan(torch.autograd.Function):
    ...
    def forward(ctx, u, delta, A, B, C, D=None, delta_bias=None, delta_softplus=False, nrows=1):
        ...
        if _SELECTIVE_SCAN_BACKEND == "oflex":
            out, x, *rest = selective_scan_cuda.fwd(u, delta, A, B, C, D, delta_bias, delta_softplus, nrows, True)
        else:
